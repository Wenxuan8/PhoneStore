...
<ol class="breadcrumb">
    ...
    <li><a href="{{ route('admin.order.index') }}"><i class="fa fa-list-alt" aria-hidden="true"></i> Quản Lý Đơn
            Hàng</a></li>
            ...
            <div class="col-xs-12">
                <h2 class="page-header">
                    <div style="display: inline-flex; align-items: center;">
                        ...
                        <div style="color: #f33;">iPhone</div>
                    </div>
        ...
        <div class="invoice-info">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    ...
                    <address>
                        <b>Admin CT05PM</b><br>
                        Phone: (+84) 0376681721<br>
                        Email: nguyenvisv@gmail.com<br>
                        Address: Nguyễn Trãi, Quận 5, TPHCM.
                    </address>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3">
                    To: <br>
...
$(document).ready(function() {
    $('.btn-print').click(function() {
        printJS({
            ...
            css: [
                '{{ asset('
                AdminLTE / bower_components / bootstrap / dist / css / bootstrap.min
                .css ') }}',
                '{{ asset('
