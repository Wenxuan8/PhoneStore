            ...
            <div class="col-md-3 margin-auto">
                <div class="search">
                    <form class="search-bar" action="{{ route('search') }}" method="get" accept-charset="utf-8">
                        <input class="input-search" type="search" name="search_key"
                            placeholder="{{ __('header.Search') }}" autocomplete="off">
                    ...
                    <div class="nav">
                        <ul>
                            <li class="nav-item {{ Helper::check_active(['home_page']) }}"><a
                                    href="{{ route('home_page') }}" title="{{ __('header.Home') }}">
                        ...
                        <div class="not-logged-menu">
                            <ul>
                                <li class="menu-item {{ Helper::check_active(['login']) }}"><a
                                        href="{{ route('login') }}" title="{{ __('header.Login') }}">
                                        <span class="fas fa-user"></span>
                                        {{ __('header.Login') }}</a>
                                </li>
                                <li class="menu-item {{ Helper::check_active(['register']) }}"><a
                                        href="{{ route('register') }}" title="{{ __('header.Register') }}">
                                ...
                                <li
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="{{ Helper::check_active(['orders_page', 'order_page']) }}"><a
                                                href="{{ route('orders_page') }}"><i class="fas fa-clipboard-list"></i>
                                                Quản Lý Đơn Hàng</a></li>
                                        <li class="{{ Helper::check_active(['show_user', 'edit_user']) }}"><a
                                                href="{{ route('show_user') }}"><i class="fas fa-user-cog"></i> Quản Lý
                                                Tài Khoản</a></li>
                                        @endif
                                        <li><a id="logout" action="#"><i class="fas fa-power-off"></i>
                                                {{ __('header.Logout') }}</a></li>
                                    </ul>
...
<div class="mobile-main-menu">
    <div class="mobile-main-menu-top">
        ...
        <div class="mb-menu-top-body">
            <div class="mb-menu-user">
                <div style="background-image: url('{{ Helper::get_image_avatar_url(Auth::user()->avatar_image) }}');">
                </div>
            </div>
            <div class="mb-menu-info">
    ...
    <div class="mobile-main-menu-bottom">
        <div class="mobile-support">
            ...
            <div class="info-support">
                <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:nguyenvisv@gmail.com"
                    title="nguyenvisv@gmail.com">nguyenvisv@gmail.com</a>
            </div>
        </div>
    </div>
</div>